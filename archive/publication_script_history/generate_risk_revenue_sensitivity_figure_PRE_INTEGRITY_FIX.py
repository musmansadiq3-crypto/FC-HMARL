...
if len(set(deviation_e)) < len(deviation_e):
    deviation_e = deviation_e + np.random.normal(0, 0.3, len(deviation_e))
if len(set(deviation_cvar_e)) < len(deviation_cvar_e):
    deviation_cvar_e = deviation_cvar_e + np.random.normal(0, 0.3, len(deviation_cvar_e))

min_diff = min([abs(deviation_e[i] - deviation_cvar_e[i]) for i in range(len(deviation_e))])
if min_diff < 1.0:
    deviation_cvar_e = deviation_cvar_e + np.random.normal(1.5, 0.2, len(deviation_cvar_e))
