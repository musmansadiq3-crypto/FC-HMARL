...
ax_a1.scatter(
    hours[measure_idx],
    pv_actual[measure_idx] + 0.02 * np.random.randn(len(measure_idx)),
    s=50,
    color="#28B463",
    alpha=0.6,
    edgecolor="black",
...
ax_a2.scatter(
    hours[measure_idx],
    load_actual[measure_idx] + 0.02 * np.random.randn(len(measure_idx)),
    s=50,
    color="#FDB813",
    alpha=0.6,
    edgecolor="black",
...
ax_a3.scatter(
    hours[measure_idx],
    ev_actual[measure_idx] + 0.015 * np.random.randn(len(measure_idx)),
    s=50,
    color="#FDB813",
    alpha=0.6,
    edgecolor="black",
...
ax_a4.scatter(
    hours[measure_idx],
    price_actual[measure_idx] + 0.02 * np.random.randn(len(measure_idx)),
    s=50,
    color="#28B463",
    alpha=0.6,
    edgecolor="black",
